...
一个自包含的单文件 HTML 报表，对比国内外 18 家厂商、79 档付费 AI 编程 / Token 订阅套餐的**折合单价（元 / 百万 tokens）**，支持总排名（划算/综合能力双模式）、按公司浏览、按模型查询与换算方法说明。无构建系统、无外部依赖、无后端。
...
| `UPDATE-WORKFLOW.md` | 数据更新流程（厂商核对清单、更新步骤、模型追踪） |
...
价格数据截至 **2026-09**，结合官方定价页、官方博客 / 公告与社区横评交叉核对；促销价以 `promo` 字段标注、常规价为准。本报表仅供研究对比，**非购买建议**。
